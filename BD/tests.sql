...
-- Format: INSERT INTO usuario(rol, usuario, contrasena, correo, nacimiento) VALUES ('2020305**-*', 'nombre apellido', 'password', 'nombre.apellido@usm.cl', TO_DATE('fecha de nacimiento', 'DD-MM-YYYY'));
...
SELECT * FROM producto_info WHERE LOWER(nombre) LIKE LOWER('%MU%');
